  ...
  return (
    ...
    <div className='w-full flex justify-between align-center font-semibold'>
        <div className='flex items-center gap-2'>
            <img className='w-6 bg-black pl-2 rounded cursor-pointer' src={assets.arrow_left} alt="" />
            <img className='w-6 bg-black pl-2 rounded cursor-pointer' src={assets.arrow_right} alt="" />
        </div>
